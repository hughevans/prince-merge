...
The first argument is a CSV containing the recipients. The CSV file requires a headers row and the bundled +standard_envelope+ template requires the following:
